...
function query1() {
	...
	var parm = { 
		url : getRootPath()
				+ "/ACC_Order_Controller_4W/query_all_alipay.action",
		data : obj,
		table_obj : $("#datatable"),
		title : [ "序号", "订单时间", "直销商", "分销商", "订单编号", "订单状态", "订单比例", "账单总额", "直销商收款", "直销商收款方式", "平台收款" ],
		data_column : [ "rownumber", "order_no", "order_no_str", "receive_acct", "divide", "order_state", "divide","pay_money","saler_money","receive_type_name","receive_money" ],
